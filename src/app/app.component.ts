...
@Component({
  ...
  template: `
    <div class="app-container">
      <mat-toolbar color="primary" fxLayoutGap="8px" class="app-toobar"
        ...
        <button *ngIf="displayAccountIcons" mat-mini-fab routerLink="/user/logout"
          matTooltip="Logou" aria-label="Logout"><mat-icon>lock_open</mat-icon>
        </button>
      </mat-toolbar>
...
export class AppComponent implements OnInit {
  ...
  private _displayAccountIcons = true;

  ngOnInit(): void {
    this.authService.authStatus.subscribe(
      authStatus => { 
        setTimeout(() => {
          this._displayAccountIcons = authStatus.isAuthenticated }, 0)
      });
  }
